...
import vc.thinker.cabbage.sys.service.NomoPermissionService;
...
public class RoleController extends BaseController {
	...
	@Autowired
	private NomoPermissionService nomoPermissionService;
	...
	@SecurityMapping(name="role.list",permGroup="role.role",userType=SysUserContant.USER_TYPE_1)
	...
	@SecurityMapping(name="role.edit",permGroup="role.role",userType=SysUserContant.USER_TYPE_1)
	@RequestMapping(value = "form")
	public String form(@ModelAttribute("role") RoleBO role, Model model) {
		
		nomoPermissionService.deleteUselessPerssion();
	...
	@SecurityMapping(name="role.delete",permGroup="role.role",userType=SysUserContant.USER_TYPE_1)

...
import vc.thinker.cabbage.web.security.AdminAuthorizingRealm;
...
public class ShiroConfig {
	...
	public org.apache.shiro.mgt.SecurityManager securityManager(AdminAuthorizingRealm systemAuthorizingRealm) {
	...
	@Bean
	public AdminAuthorizingRealm systemAuthorizingRealm(CountValidateCodeHandler validateCodeHandler){
	...
	public CountValidateCodeHandler validateCodeHandler(){
		...
		validateCodeHandler.setFailCount(30);
	...
	public FormAuthenticationFilter formAuthenticationFilter(CountValidateCodeHandler validateCodeHandler){
		SysFormAuthenticationFilter formAuthenticationFilter=new SysFormAuthenticationFilter();
		//<!-- 最大session 数 -->

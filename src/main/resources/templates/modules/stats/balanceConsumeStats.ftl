...
<div class="page-container-custom">
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span><@spring.message code="stats.balanceStatistics"></@spring.message></span>
            </li>
        </ul>
    </div>
    ...
    <div class="portlet light ">
        <div class="portlet-title">
            <div class="caption">
                <span class="caption-subject font-green bold"><@spring.message code="stats.balanceStatistics"></@spring.message></span>
            </div>
        </div>

    <@form.form id="searchForm" modelAttribute="vo" action="${ctx}/sys/stats/balanceConsumeStats" method="post" class="breadcrumb form-search">
        <div>
            &nbsp;&nbsp;&nbsp;
        ...
        require(
            ...
            function (ec, theme) {
                ...
                depositLine.setOption(
                	{
                		title : {
					        text: '${vo.time!}<#if vo.statsType=='1'>year </#if><#if vo.statsType=='2'>month </#if><@spring.message code="sys.growthTrend"></@spring.message>',
					        x:'left'
					    },
					    tooltip : {
					        trigger: 'axis'
					     ...
					     legend: {
					        data:['<@spring.message code="sys.balanceConsumption"></@spring.message>']
					    },
					    toolbox: {
					        show : true,
					        feature : {
